...
def OutputToScreen(ind_rlock):
        ...
        while 1:
                if i > 3:
                        i = 0
                print("{:^70}".format("Proxy attack status"))
...
def downloadsocks(choice):
        if choice == "4":
                ...
                try:#credit to All3xJ
                        ...
                        pass
                print("already downloaded socks4 list as socks4.txt")
        if choice == "5":
                ...
                try:
                        ...
                        f.close()
                print("already downloaded socks5 list as socks5.txt")
...
def main():
        ...
        parser.add_argument("-mode", help="select mode (cc/post)")
        parser.add_argument("-proxy_type", help="select socks mode (4,5)")
        ...
        choice = args.proxy_type
        if choice == "4":
                socks_type = 4
        else:
                socks_type = 5
        
        thread_num = int(args.t)
        CheckerOption()
        if len(proxies) == 0:
